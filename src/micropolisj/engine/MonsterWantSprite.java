...
/**
 * Implements a something for the monster to want more than rampaging.
 */
public class MonsterWantSprite extends Sprite
{
	int count;
	int soundCount;
	int destX;
	...
	public MonsterWantSprite(Micropolis engine, int xpos, int ypos)
	{
		super(engine, SpriteKind.LGZ);
		this.x = xpos * 16 + 8;
		this.y = ypos * 16 + 8;
		this.width = 48;
		this.height = 48;
